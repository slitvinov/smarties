...
SwarmCylinders::SwarmCylinders(int n_, double radius_, double rmin_, double A_, double K1_, double K2_, double alpha_) :
		n(n_), radius(radius_), rmin(rmin_), A(A_), K1(K1_), K2(K2_), alpha(alpha_), spline(A_, K1_, K2_, alpha_), dt(1e-2), threshold(5e-6), factorCylinder(0.001), factorBoundary(0.05)
{
