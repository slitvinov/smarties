...
//=============================================================================
VISIBLE extern "C" void smarties_sendInitState(void*const ptr2comm,
  const double*const S, const int state_dim, const int agentID);

VISIBLE extern "C" void smarties_sendTermState(void*const ptr2comm,
  const double*const S, const int state_dim, const double R, const int agentID);

VISIBLE extern "C" void smarties_sendLastState(void*const ptr2comm,
  const double*const S, const int state_dim, const double R, const int agentID);

VISIBLE extern "C" void smarties_sendState(void*const ptr2comm,
  const double*const S, const int state_dim, const double R, const int agentID);

VISIBLE extern "C" void smarties_recvAction(void*const ptr2comm,
  double*const A, const int action_dim, const int agentID);
//=============================================================================

//=============================================================================
VISIBLE extern "C" void smarties_set_num_agents(void*const ptr2comm,
  const int num_agents);

VISIBLE extern "C" void smarties_set_state_action_dims(void*const ptr2comm,
  const int state_dim, const int action_dim, const int agent_id);

VISIBLE extern "C" void smarties_set_action_scales_default(void*const ptr2comm,
...
VISIBLE extern "C" void smarties_set_action_scales_pointer(void*const ptr2comm,
  const double* const upper_scale, const double* const lower_scale,
  const int*const are_bounds, const int action_dim, const int agent_id);

VISIBLE extern "C" void smarties_set_action_options_default(void*const ptr2comm,
  const int noptions, const int agent_id);

VISIBLE extern "C" void smarties_set_action_options_dim(void*const ptr2comm,
  const int*const noptions, const int action_dim, const int agent_id);

VISIBLE extern "C" void smarties_set_state_observable(void*const ptr2comm,
  const int*const bobservable, const int state_dim, const int agent_id);

VISIBLE extern "C" void smarties_set_state_scales(void*const ptr2comm,
  const double*const upper_scale, const double*const lower_scale,
  const int state_dim, const int agent_id);

VISIBLE extern "C" void smarties_set_is_partially_observable(
  void*const ptr2comm, const int agent_id);

VISIBLE extern "C" void smarties_finalize_problem_description(void*const ptr2comm);

VISIBLE extern "C" void smarties_env_has_distributed_agents(void*const ptr2comm);

VISIBLE extern "C" void smarties_agents_define_different_MDP(void*const ptr2comm);

VISIBLE extern "C" void smarties_disableDataTrackingForAgents(
  void*const ptr2comm, const int agentStart, const int agentEnd);

VISIBLE extern "C" void smarties_set_preprocessing_conv2d(void*const ptr2comm,
...
VISIBLE extern "C" void smarties_set_num_appended_past_observations(
