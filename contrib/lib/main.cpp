...
void smarties_sendInitState(void * ptr2comm, double *S,
...
void smarties_sendTermState(void * ptr2comm, double *S,
...
void smarties_sendLastState(void * ptr2comm, double *S,
                            int state_dim, double R, int agentID) {
  std::vector<double> svec(S, S + state_dim);
...
void smarties_sendState(void * ptr2comm, double *S,
                        int state_dim, double R, int agentID) {
  std::vector<double> svec(S, S + state_dim);
...
void smarties_setStateActionDims(void * ptr2comm, int state_dim,
...
void smarties_setActionScales(void * ptr2comm,
                              double * upper_scale,
...
void smarties_setActionScalesBounds(void * ptr2comm,
                                    double * upper_scale,
                                    double * lower_scale,
                                    int *are_bounds, int action_dim,
                                    int agent_id) {
  std::vector<double> upper(upper_scale, upper_scale + action_dim);
  std::vector<double> lower(lower_scale, lower_scale + action_dim);
...
void smarties_setActionOptions(void * ptr2comm, int noptions,
                               int agent_id) {
  static_cast<smarties::Communicator *>(ptr2comm)->setActionOptions(noptions,
                                                                    agent_id);
}

void smarties_setActionOptionsPerDim(void * ptr2comm,
                                     int *noptions, int action_dim,
                                     int agent_id) {
...
void smarties_setStateObservable(void * ptr2comm,
                                 int *bobservable, int state_dim,
                                 int agent_id) {
...
void smarties_setStateScales(void * ptr2comm,
                             double * upper_scale,
                             double * lower_scale, int state_dim,
                             int agent_id) {
...
void smarties_setNumAppendedPastObservations(void * ptr2comm,
...
void smarties_sendinitstate_(void * ptr2comm, double *S,
                             int state_dim, int agentID) {
  std::vector<double> svec(S, S + state_dim);
  static_cast<smarties::Communicator *>(ptr2comm)->sendInitState(svec, agentID);
}

void smarties_sendtermstate_(void * ptr2comm, double *S,
                             int state_dim, double R, int agentID) {
  std::vector<double> svec(S, S + state_dim);
  static_cast<smarties::Communicator *>(ptr2comm)->sendTermState(svec, R,
                                                                 agentID);
...
void smarties_sendlaststate_(void * ptr2comm, double *S,
                             int state_dim, double R, int agentID) {
  std::vector<double> svec(S, S + state_dim);
  static_cast<smarties::Communicator *>(ptr2comm)->sendLastState(svec, R,
                                                                 agentID);
...
void smarties_sendstate_(void * ptr2comm, double *S,
                         int state_dim, double R, int agentID) {
  std::vector<double> svec(S, S + state_dim);
  static_cast<smarties::Communicator *>(ptr2comm)->sendState(svec, R, agentID);
}
...
void smarties2_setactionscales_(void * ptr2comm,
                               double * upper_scale,
                               double * lower_scale, int are_bounds,
                               int action_dim, int agent_id) {
  std::vector<double> upper(upper_scale, upper_scale + action_dim);
...
void smarties_setactionscalesbounds_(void * ptr2comm,
                                     double * upper_scale,
                                     double * lower_scale,
                                     int *are_bounds,
                                     int action_dim, int agent_id) {
...
void smarties_setactionoptions_(void * ptr2comm, int noptions,
                                int agent_id) {
  static_cast<smarties::Communicator *>(ptr2comm)->setActionOptions(noptions,
                                                                    agent_id);
}

void smarties_setactionoptionsperdim_(void * ptr2comm,
                                      int *noptions, int action_dim,
                                      int agent_id) {
  std::vector<int> optionsvec(noptions, noptions + action_dim);
  static_cast<smarties::Communicator *>(ptr2comm)->setActionOptions(optionsvec,
...
void smarties_setstateobservable_(void * ptr2comm,
                                  int *bobservable, int state_dim,
                                  int agent_id) {
  std::vector<bool> optionsvec(bobservable, bobservable + state_dim);
  static_cast<smarties::Communicator *>(ptr2comm)->setStateObservable(
...
void smarties_setstatescales_(void * ptr2comm,
                              double * upper_scale,
                              double * lower_scale, int state_dim,
                              int agent_id) {
  std::vector<double> upper(upper_scale, upper_scale + state_dim);
...
void smarties_agentsdefinedifferentmdp_(void * ptr2comm) {
  static_cast<smarties::Communicator *>(ptr2comm)->agentsDefineDifferentMDP();
}

void smarties_disabledatatrackingforagents_(void * ptr2comm,
...
void smarties_setnumappendedpastobservations_(void * ptr2comm,
                                              int n_appended, int agentID) {
  static_cast<smarties::Communicator *>(ptr2comm)
      ->setNumAppendedPastObservations(n_appended, agentID);
}
