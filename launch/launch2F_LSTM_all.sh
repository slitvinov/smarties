...
#./launch2F_LSTM_all.sh Movie_Eff_All_Box
...
cp ../factory/factory2FMovieAll ${BASEPATH}${RUNFOLDER}/factory
cp all_box_LSTM_Eff_decay ${BASEPATH}${RUNFOLDER}/policy.net_tmp
