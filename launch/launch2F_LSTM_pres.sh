...
#./launch2F_LSTM_pres.sh Movie_Eff_Pres_Boxed
...
cp ../factory/factory2FMoviePres ${BASEPATH}${RUNFOLDER}/factory
cp vels_box_LSTM_Eff ${BASEPATH}${RUNFOLDER}/policy.net_tmp
