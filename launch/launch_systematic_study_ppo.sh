...
source launchDaint_openai.sh humanw_${POSTFIX} ${NMASTERS} Humanoid-v2               settings/settings_bench_ppo.sh
source launchDaint_openai.sh spider_${POSTFIX} ${NMASTERS} Ant-v2                    settings/settings_bench_ppo.sh
source launchDaint_openai.sh walker_${POSTFIX} ${NMASTERS} Walker2d-v2               settings/settings_bench_ppo.sh
source launchDaint_openai.sh cheeta_${POSTFIX} ${NMASTERS} HalfCheetah-v2            settings/settings_bench_ppo.sh
source launchDaint_openai.sh swimmr_${POSTFIX} ${NMASTERS} Swimmer-v2                settings/settings_bench_ppo.sh
source launchDaint_openai.sh hopper_${POSTFIX} ${NMASTERS} Hopper-v2                 settings/settings_bench_ppo.sh
source launchDaint_openai.sh reachr_${POSTFIX} ${NMASTERS} Reacher-v2                settings/settings_bench_ppo.sh
#source launchDaint_openai.sh invpnd_${POSTFIX} ${NMASTERS} InvertedPendulum-v1      settings/settings_bench_ppo.sh
source launchDaint_openai.sh dblpnd_${POSTFIX} ${NMASTERS} InvertedDoublePendulum-v2 settings/settings_bench_ppo.sh

POSTFIX=ACE_00_TRIAL${RUNTRIAL}
source launchDaint_openai.sh humanw_${POSTFIX} ${NMASTERS} Humanoid-v2               settings/settings_ACER.sh 
source launchDaint_openai.sh spider_${POSTFIX} ${NMASTERS} Ant-v2                    settings/settings_ACER.sh 
source launchDaint_openai.sh walker_${POSTFIX} ${NMASTERS} Walker2d-v2               settings/settings_ACER.sh 
source launchDaint_openai.sh cheeta_${POSTFIX} ${NMASTERS} HalfCheetah-v2            settings/settings_ACER.sh 
source launchDaint_openai.sh swimmr_${POSTFIX} ${NMASTERS} Swimmer-v2                settings/settings_ACER.sh 
source launchDaint_openai.sh hopper_${POSTFIX} ${NMASTERS} Hopper-v2                 settings/settings_ACER.sh 
source launchDaint_openai.sh reachr_${POSTFIX} ${NMASTERS} Reacher-v2                settings/settings_ACER.sh 
#source launchDaint_openai.sh invpnd_${POSTFIX} ${NMASTERS} InvertedPendulum-v1      settings/settings_ACER.sh 
source launchDaint_openai.sh dblpnd_${POSTFIX} ${NMASTERS} InvertedDoublePendulum-v2 settings/settings_ACER.sh 

POSTFIX=DPG_00_TRIAL${RUNTRIAL}
source launchDaint_openai.sh humanw_${POSTFIX} ${NMASTERS} Humanoid-v2               settings/settings_DPG.sh 
source launchDaint_openai.sh spider_${POSTFIX} ${NMASTERS} Ant-v2                    settings/settings_DPG.sh 
source launchDaint_openai.sh walker_${POSTFIX} ${NMASTERS} Walker2d-v2               settings/settings_DPG.sh 
source launchDaint_openai.sh cheeta_${POSTFIX} ${NMASTERS} HalfCheetah-v2            settings/settings_DPG.sh 
source launchDaint_openai.sh swimmr_${POSTFIX} ${NMASTERS} Swimmer-v2                settings/settings_DPG.sh 
source launchDaint_openai.sh hopper_${POSTFIX} ${NMASTERS} Hopper-v2                 settings/settings_DPG.sh 
source launchDaint_openai.sh reachr_${POSTFIX} ${NMASTERS} Reacher-v2                settings/settings_DPG.sh 
#source launchDaint_openai.sh invpnd_${POSTFIX} ${NMASTERS} InvertedPendulum-v1      settings/settings_DPG.sh 
source launchDaint_openai.sh dblpnd_${POSTFIX} ${NMASTERS} InvertedDoublePendulum-v2 settings/settings_DPG.sh 
